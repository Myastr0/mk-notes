...
id: architecture
title: Architecture
description: This document outlines the strategy to build the notion page architecture based on your directory organization
---
...
For technical details about the implementation, please refer to our [Contributing Guide](../contributing/implementation-details).
