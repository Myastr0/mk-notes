...
Notion API has a **maximum nesting depth of 2 levels** for bulleted and numbered lists. Attempting to create lists with more than 2 levels of nesting will result in a validation error.

#### What happens when you exceed the limit?

When you try to sync markdown content with more than 2 levels of list nesting, you'll encounter an error like this:
...
2. **Convert deep nesting to paragraphs**
   ...
   Additional content as paragraph text instead of Level 3 list item.
   ```
