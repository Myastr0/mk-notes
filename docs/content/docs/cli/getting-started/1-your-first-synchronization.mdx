...
<Callout type="tip" title="Enable incremental updates">
...
<Callout type="tip" title="Recommended for ongoing sync">
...
Learn more about all available options in the [CLI Commands](../guides/cli-commands) guide.
