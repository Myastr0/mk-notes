import { BlockObjectRequestWithoutChildren as _BlockObjectRequestWithoutChildren, PageObjectResponse, PartialUserObjectResponse } from '@notionhq/client/build/src/api-endpoints';
import { SupportedEmoji } from '../../domains/elements/types';
export type PartialCreatePageBodyParameters = Pick<CreatePageBodyParameters, 'properties' | 'children' | 'icon'>;
export type BlockObjectRequestWithoutChildren = _BlockObjectRequestWithoutChildren;
...
export type PageProperties = Record<string, TitleProperty | RichTextProperty | NumberProperty | UrlProperty | SelectProperty | MultiSelectProperty | PeopleProperty | EmailProperty | PhoneNumberProperty | DateProperty | CheckboxProperty | RelationProperty | FilesProperty | StatusProperty>;
...
export type BlockObjectRequest = EmbedBlock | BookmarkBlock | ImageBlock | VideoBlock | PdfBlock | FileBlock | AudioBlock | CodeBlock | EquationBlock | DividerBlock | BreadcrumbBlock | TableOfContentsBlock | LinkToPageBlock | TableRowBlock | TableBlock | ColumnBlock | ColumnListBlock | Heading1Block | Heading2Block | Heading3Block | ParagraphBlock | BulletedListItemBlock | NumberedListItemBlock | QuoteBlock | ToDoBlock | ToggleBlock | TemplateBlock | CalloutBlock | SyncedBlock;
export declare const isPageObjectResponse: (obj: Record<string, unknown>) => obj is PageObjectResponse;
export {};
